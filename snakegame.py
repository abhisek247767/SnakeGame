...
class Game:
    ...
    def render_background(self):
        bg = pygame.image.load("yeback.png")
    ...
    def run(self):
        ...
        while running:
            for event in pygame.event.get():   #pygame.event give keyboard input 
                if event.type == KEYDOWN:      # if keydown key we press and similarly other
